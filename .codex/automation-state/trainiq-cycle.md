...
Verification summary: QA-035 reproduced RED when Activity recreation closed the populated custom-exercise dialog, then GREEN with `Rotatie squat`, `Benen`, and `Halters` retained. The hardened flow class passed 10/10; final assemble/unit/lint/Android-test compile PASS; full connected suite and Room marker PASS with 59 Android 16 tests each; profileable/macrobenchmark packaging and signing-readiness PASS; screenshot/UI-tree recreation inspection PASS; cold debug launch PASS in 6414 ms with no TrainIQ fatal/ANR signal. Non-production branch debug APK SHA-256: `A8E793E731D38574F6A09C3ED9A6E6C6168321D2A2C0DE002470419FE151F277`.
