...
Last useful change: Moved meal save/delete from full JSON mirror import to targeted meals and meal_items upsert/delete transactions.
...
Next safest action: Continue QA-2026-05-09-001/QA-2026-05-10-014 with active workout finish, active workout undo, routine edit/delete, or profile targeted Room writes.
