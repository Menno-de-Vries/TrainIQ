...
- P0:
  - QA-2026-05-09-001: targeted DAO-backed hot-path persistence partially done; remaining workout day/exercise add/remove and routine set add/delete/move hot paths still open.
...
1. Continue QA-2026-05-09-001/QA-2026-05-10-014 by moving workout day/exercise add/remove or routine set add/delete/move to targeted Room writes with process-restart correctness tests.
