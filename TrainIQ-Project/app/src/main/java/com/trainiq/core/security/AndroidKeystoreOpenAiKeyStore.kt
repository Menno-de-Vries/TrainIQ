...
@Singleton
class AndroidKeystoreOpenAiKeyStore @Inject constructor(
    @ApplicationContext context: Context,
) : OpenAiEncryptedKeyStore {
    private val storage = context.getSharedPreferences(EncryptedOpenAiPrefsName, Context.MODE_PRIVATE)
...
private const val KeyAlias = "trainiq_openai_api_key_v1"
private const val Transformation = "AES/GCM/NoPadding"
private const val GcmTagBits = 128
private const val EncryptedOpenAiPrefsName = "trainiq_encrypted_openai"
private const val IvKey = "openai_api_key_iv"
private const val CiphertextKey = "openai_api_key_ciphertext"
