...
class HealthConnectPermissionPolicyTest {
    ...
    fun samsungHealthDataSdkParityPlanRequiresExplicitAarAndPhysicalDevice() {
        ...
        assertFalse(directSource.contains("suspend fun requestTodayStepPermission(activity: Activity)"))
        assertFalse(directSource.contains(".samsungResolutionStatus(activity)"))
        assertFalse(directSource.contains("resolveSamsungAction(activity)"))
        assertFalse(directSource.contains("StatusSdkResolutionStarted"))
        assertFalse(directSource.contains("StatusSdkResolutionFailed"))
        ...
        assertFalse(directSource.contains("requestTodayStepPermission"))
        assertFalse(directSource.contains("requestPermissions"))
